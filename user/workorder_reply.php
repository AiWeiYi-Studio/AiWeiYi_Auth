...
$id = $_GET['id'];
$row_1 =$DB->get_row("select * from website_workorder where id = '{$id}' and user = '{$udata['uid']}' limit 1");
                        ...
                        <?php }else{?>
                            <div class="huifu">
                                ...
                                <div class="form-group">
                                    <textarea id="text"class="form-control" rows="8" placeholder="回复会通过邮箱通知站长"></textarea>
                                </div>
                                <div class="form-group">
