...
$请求示例 = ''.$siteurls.'api/api/bing.php?token='.$udata['token'];
$接口地址 = ''.$siteurls.'api/api/bing.php';
$title1='每日必应图片';
$title2='获取必应的每日图片';
?>
                                        ...
                                        <table class="layui-table" lay-size="sm">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>否</td>
                                                    <td>String</td>
                                                    <td>数组等于1则直接输出图片，否则返回图片链接</td>
                                                </tr>
                                                <tr>
                                                    <td>day</td>
                                                    <td>否</td>
                                                    <td>String</td>
                                                    <td>0为今天，1为昨天，2为前天，以此类推</td>
                                                </tr>
											</tbody>
										</table>
...
$result = file_get_contents("<?php echo $siteurls;?>api/api/bing.php?token=<?php echo $udata['token'];?>");
...
<p class="linep">成功返回示例：</p>
				<pre class="layui-code">{
				       ...
				       "imgurl":"https://cn.bing.com/th?id=OHR.SouthCoast_EN-US4824290612_1920x1080.jpg&rf=LaDigue_1920x1080.jpg&pid=hp",
				       "img_date":"20211205",
				       "user_money":"105.993",
				       "api_money":"0.001"
				}</pre>
		...
		<div class="layui-tab-item">
		    <blockquote class="layui-elem-quote">调用单价：<?php echo $conf['api_bing_money'];?>/次</blockquote>
		    <blockquote class="layui-elem-quote">总调用次数：<?php echo $conf['api_bing_number'];?>/次</blockquote>
		   </div>
		</div>
	</div>
</div>
