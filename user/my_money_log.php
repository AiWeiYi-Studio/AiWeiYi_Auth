...
$numrows=$DB->count("SELECT count(*) from website_money_log where {$sql} and user='".$udata['uid']."'");
?>
<!--页面主要内容-->
                        ...
                        <div class="table-responsive">
                            ...
                            <tbody>
                                <?php
                                    ...
                                    $rs=$DB->query("SELECT * FROM website_money_log WHERE  {$sql} and user='".$udata['uid']."' order by id desc limit $offset,$pagesize");
