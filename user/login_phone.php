...
<input type="text" placeholder="请输入您的手机号" class="form-control" id="phone" />
<span class="mdi mdi-cellphone form-control-feedback" aria-hidden="true"></span>
</div>

<div class="form-group has-feedback feedback-left row">
<div class="col-xs-7">
<input type="text" class="form-control" placeholder="请输入网页验证码" id="codes"/>
...
<div class="form-group has-feedback feedback-left row">
<div class="col-xs-7">
<input type="text" class="form-control" placeholder="请输入手机验证码" id="code"/>
<span class="mdi mdi-check-all form-control-feedback" aria-hidden="true"></span>
</div>
<div class="col-xs-5">
...
function send_code(){
	...
	var ii = layer.load(0, {shade:[0.1,'#fff']});
		$.ajax({
		    type : "POST",
			url : "ajax_login.php?act=login_phone_code",
...
function login(){
	...
	var ii = layer.load(0, {shade:[0.1,'#fff']});
		$.ajax({
		    type : "POST",
			url : "ajax_login.php?act=login_phone",
			data : {phone:phone,code:code,codes:codes},
			dataType : 'json',
			success : function(data) {
				layer.close(ii);
				layer.msg(data.msg)
