                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <select id="class" class="form-control" default="<?php echo $_GET['class'];?>">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="name" class="form-control" value="<?=$row['img']?>" >
                        </div>
                        <div class="form-group">
                            <label for="text">浏览量</label>
                            <input type="number" id="number" class="form-control" value="<?php echo $_POST['number'];?>">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control js-datetimepicker" type="text" id="date" value="<?php echo $_POST['time']?$_POST['time']:$date;?>" data-side-by-side="true" data-locale="zh-cn" data-format="YYYY-MM-DD HH:mm:ss" />
                        </div>
                        <div class="form-group">
                            <label for="text">文章内容：</label>
                            <textarea id="Ueditor" style="width:100%;height:400px;"></textarea>
                        </div>
                        <div class="form-group">
