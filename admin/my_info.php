...
<p class="m-0">微博登陆：<?php echo $oauth_weibo;?></p>
</div>
<div class="col-sm-6 col-lg-6">
<p class="m-0">Q Q 登陆：<?php echo $oauth_qq;?></p>
</div>
<div class="col-sm-6 col-lg-6">
<p class="m-0">微信登陆：<?php echo $oauth_weixin;?></p>
</div>
<div class="col-sm-6 col-lg-6">
<p class="m-0">支付宝登陆：<?php echo $oauth_alipay;?></p>
</div>
</div>
</div>
</div>
