...
$numrows = $DB->count("SELECT count(*) from website_pay where {$sql}");
?>
<!--页面主要内容-->
                        ...
                        <div class="table-responsive">
                            ...
                            <tbody>
                                <?php
                                    ...
                                    $rs=$DB->query("SELECT * FROM website_pay where {$sql} order by id desc limit $offset,$pagesize");
...
<script>
    ...
    function city(id){
        ...
        $.ajax({
		    type : "POST",
			url : "ajax_user.php?act=get_city_my_pay&id="+id,
			data : {},
			dataType : 'json',
