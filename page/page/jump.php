...
<body>
    <div class="top-bar-guidance">
        <p>
            点击右上角
            <img src="//gw.alicdn.com/tfs/TB1xwiUNpXXXXaIXXXXXXXXXXXX-55-55.png" class="icon-safari" />
    ...
    <a data-clipboard-text="<?php echo $siteurl?>" class="app-download-btn" id="J_BtnDowanloadApp">
        点此复制本站网址
    </a>
