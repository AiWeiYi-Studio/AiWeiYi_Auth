    ...
    public function setLanguage($langcode = 'en', $lang_path = '')
    {
        ...
        */
        $PHPMAILER_LANG = [
            ...
            'buggy_php' => '您的 PHP 版本受到可能导致消息损坏的错误的影响。要修复它，请切换到使用 SMTP 发送，禁用您的 php.ini 中的 mail.add_x_header 选项，切换到 MacOS 或 Linux，或将您的 PHP 升级到 版本 7.0.17+ 或 7.1.3+',
            ...
            'invalid_header' => '标头名称或值无效',
            'invalid_hostentry' => '无效的主机条目',
            'invalid_host' => '无效的主机',
