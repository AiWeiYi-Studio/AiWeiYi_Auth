...
?>
 <div class="card">
        <div class="card-header"><h4>解除数据库更新锁定</h4></div>
          <div class="card-body">
...
?>
      <div class="card">
        <div class="card-header"><h4>解除数据库更新锁定</h4></div>
          ...
          <a href="?token=<?php echo $token?>&mod=del" class="btn btn-w-md btn-round btn-info">解除锁定</a>
          <a href="?token=<?php echo $token?>&mod=do" class="btn btn-w-md btn-round btn-info">重新上锁</a>
    
    
<?php }elseif($mod=='do'){
file_put_contents("../../system/update/update.lock",'数据库更新锁');
?>
      <div class="card">
        <div class="card-header"><h4>解除数据库更新锁定</h4></div>
          <div class="card-body">
...
<!--解除安装开始-->
<?php }elseif($mod=='del'){
if(file_exists("../../system/update/update.lock")){
unlink("../../system/update/update.lock");
}
?>
      <div class="card">
        <div class="card-header"><h4>解除数据库更新锁定</h4></div>
          ...
          <div class="alert alert-danger alert-dismissible" role="alert">
            <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            <strong>提示：</strong>解除系统数据库更新锁定成功，目前系统处于危险状态！
          </div>
          <div class="alert alert-danger alert-dismissible" role="alert">
            <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            <strong>提示：</strong>请点击前往安装！<a href="../../system/update">点此安装更新</a>
          </div>
                    <div class="alert alert-danger alert-dismissible" role="alert">
            <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
